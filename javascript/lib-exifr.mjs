...
function p(e) {
  return (
    void 0 === e ||
    (e instanceof Map ? 0 === e.size : 0 === Object.values(e).filter(d).length)
  );
}
function g(e) {
  let t = new Error(e);
    ...
    if (
      ...
      void 0 === i && (i = e.byteLength - t),
        (t += e.byteOffset) + i > e.byteOffset + e.byteLength &&
          g('Creating view outside of available memory in ArrayBuffer');
...
function D(e, n) {
  return 'string' == typeof e
    ? O(e, n)
    : t && !i && e instanceof HTMLImageElement
    ? O(e.src, n)
    : e instanceof Uint8Array ||
...
class Y extends _ {
  ...
  constructor(e, t, i, n) {
    if (
      ...
      c(this, 'pick', new Set()),
      c(this, 'deps', new Set()),
      c(this, 'translateKeys', !1),
      c(this, 'translateValues', !1),
      c(this, 'reviveValues', !1),
      (this.key = e),
      (this.enabled = t),
  ...
  finalizeFilters() {
    !this.enabled && this.deps.size > 0
      ...
      : this.enabled && this.pick.size > 0 && ee(this.pick, this.deps);
  }
}
var $ = {
    jfif: !1,
...
class q extends _ {
  ...
  constructor(e) {
    super(),
      !0 === e
        ...
        : g(`Invalid options argument ${e}`),
      void 0 === this.firstChunkSize &&
        (this.firstChunkSize = t
  ...
  setupFromObject(e) {
    ...
    this.setupGlobalFilters(e.pick, e.skip, H, j),
      !0 === e.tiff
        ? this.batchEnableWithBool(H, !0)
        : !1 === e.tiff
        ? this.batchEnableWithUserValue(H, e)
        : Array.isArray(e.tiff)
        ? this.setupGlobalFilters(e.tiff, void 0, H)
        : 'object' == typeof e.tiff &&
          this.setupGlobalFilters(e.tiff.pick, e.tiff.skip, H);
  }
  ...
  traverseTiffDependencyTree() {
    ...
    n.needed && (t.deps.add(40965), e.deps.add(40965)),
      t.needed && e.deps.add(34665),
      i.needed && e.deps.add(34853),
      (this.tiff.enabled =
        H.some((e) => !0 === this[e].enabled) ||
        this.makerNote ||
        this.userComment);
  ...
  get onlyTiff() {
    return (
      !V.map((e) => this[e].enabled).some((e) => !0 === e) && this.tiff.enabled
    );
  }
  checkLoadedPlugins() {
...
class te {
  constructor(e) {
    c(this, 'parsers', {}),
      c(this, 'output', {}),
      c(this, 'errors', []),
      c(this, 'pushToErrors', (e) => this.errors.push(e)),
...
class se {
  constructor(e, t, i) {
    c(this, 'errors', []),
      c(this, 'ensureSegmentChunk', async (e) => {
        let t = e.start,
          i = e.size || 65536;
        if (this.file.chunked)
          ...
          this.file.byteLength > t + i
            ...
            : g('Segment unreachable: ' + JSON.stringify(e));
        return e.chunk;
      }),
...
class he extends se {
  ...
  setupSegmentFinderArgs(e) {
    !0 === e
      ? ((this.findAll = !0), (this.wanted = new Set(T.keyList())))
      : ((e =
          void 0 === e
            ? T.keyList().filter((e) => this.options[e].enabled)
            : e.filter((e) => this.options[e].enabled && T.has(e))),
        (this.findAll = !1),
      ...
      e > n.byteLength &&
        g(
          `Invalid TIFF value offset. block: ${i.toUpperCase()}, tag: ${t.toString(
            16
          )}, type: ${s}, offset ${e} is outside of chunk size ${n.byteLength}`
        ),
      1 === s)
    )
...
class fe extends ce {
  ...
  async parseExifBlock() {
    ...
    if (
      ...
      return;
    this.file.tiff &&
      (await this.file.ensureChunk(this.exifOffset, S(this.options)));
  ...
  async parseGpsBlock() {
    ...
    return (
      e &&
        e.has(2) &&
        e.has(4) &&
        (e.set('latitude', de(...e.get(2), e.get(1))),
  ...
  assignToOutput(e, t) {
    if (this.globalOptions.mergeOutput) Object.assign(e, t);
      ...
      for (let [i, n] of Object.entries(t)) this.assignObjectToOutput(e, i, n);
  }
}
function de(e, t, i, n) {
  var s = e + t / 60 + i / 3600;
...
const Ce = Object.assign({}, ge, { tiff: !1, ifd1: !0, mergeOutput: !1 });
async function ye(e) {
  let t = new te(Ce);
  await t.read(e);
...
async function Ae(e) {
  let t = await Pe(e);
  return Object.assign({ canvas: we, css: Te }, ke[t]);
}
class De extends I {
  constructor(...e) {
    super(...e),
      c(this, 'ranges', new Oe()),
...
A.set(
  ...
  class extends ve {
    ...
    readChunked() {
      return (
        (this.chunked = !0), (this.size = this.input.size), super.readChunked()
      );
    }
...
A.set(
  ...
  class extends ve {
    ...
    async _readChunk(e, t) {
      ...
      let s = await h(this.input, { headers: n }),
...
I.prototype.getUint64 = function (e) {
  ...
  return t < 1048575
    ...
    ? (console.warn(
      ...
      (r(t) << r(32)) | r(i))
    : void g('Trying to read 64b value but JS can only handle 53b numbers.');
};
class Re extends se {
  parseBoxes(e = 0) {
    let t = [];
...
function He(e) {
  ...
  if (0 === e[1] && 0 === e[e.length - 1])
    for (let i = 0; i < e.length; i += 2) t.push(je(e[i + 1], e[i]));
...
class We extends re {
  static canHandle(e, t) {
    return (
      ...
      'http://ns.adobe.com/' ===
        e.getString(t + 4, 'http://ns.adobe.com/'.length)
    );
  }
  static headerLength(e, t) {
    return 'http://ns.adobe.com/xmp/extension/' ===
      e.getString(t + 4, 'http://ns.adobe.com/xmp/extension/'.length)
      ? 79
...
class Ke {
  static findAll(e) {
    return qe(e, /([a-zA-Z0-9-]+):([a-zA-Z0-9-]+)=("[^"]*"|'[^']*')/gm).map(
      Ke.unpackMatch
    );
  }
...
class Xe {
  static findAll(e, t, i) {
    if (void 0 !== t || void 0 !== i) {
      ...
      n =
        /<([\w\d-]+):([\w\d-]+)(#\d+)?((\s+?[\w\d-:]+=("[^"]*"|'[^']*'))*\s*)(\/>|>([\s\S]*?)<\/\1:\2\3>)/gm;
  ...
  constructor(e, t, i, n) {
    (this.ns = e),
      ...
      (this.value = 0 === this.children.length ? Qe(n) : void 0),
...
class ut extends se {
  constructor(...e) {
    super(...e),
      c(this, 'catchError', (e) => this.errors.push(e)),
      c(this, 'metaChunks', []),
      c(this, 'unknownChunks', []);
  }
  static canHandle(e, t) {
    return (
      35152 === t &&
  ...
  async findXmp() {
    ...
    for (let t of e) {
      'XML:com.adobe.xmp' ===
        t.chunk.getString(0, 'XML:com.adobe.xmp'.length) &&
